...
function Products(props){
    ...
    return (
        ...
        <div class="displayCards card" style={{width: "18rem"}}>
          ...
          <div class="card-body">
            ...
            <button class="btn btn-lg btn-block btn-outline-dark" type="button" onClick={() => {addToCart(id)}}>Add to Cart <ShoppingCart/></button>
          </div>
        </div>
      </div>
    );
